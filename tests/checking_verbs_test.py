...
class CheckingVerbTest(unittest.TestCase):
    ...
    def test_all_require_verbs(self):
        ...
        cases = [
            ...
            ("require: table_name_max_length 10",
             t(name="short", columns=[c("a_column_name_way_too_long")]),
             t(name="this_name_is_too_long")),
            ("require: column_name_max_length 10",
             t(name="a_table_name_way_too_long", columns=[c("id")]),
             t(name="short", columns=[c("a_column_name_way_too_long")])),
